...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2022 at 04:42 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `product_get_data` (IN `product_id` INT)   BEGIN
    ...
    LEFT JOIN member M ON M.id = C.customer_id
...
(1, 'dinhthevinh0310', 'fc5e038d38a57032085441e7fe7010b0', 'Vinh', 'Đinh Thế', '0837511890', 'vinh@mail.com', '123/45, Đường kiêng, P.1, Q.2', 1669660374, 1669306417, 1),
...
(13, 'johncena', 'fc5e038d38a57032085441e7fe7010b0', 'Vinh', 'Dinh The', '0523840380', 'dtvince0310@gmail.com', '109/5, Thai Phien, P.2, DQ.11', 1670008994, 1669489457, 0),
...
INSERT INTO `product_comment` (`id`, `product_id`, `customer_id`, `rate`, `comments`, `date_created`) VALUES
